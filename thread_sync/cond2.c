...
int main(void) {
    ...
    pthread_create(&tid1, &attr, producer, "生产者1");
    pthread_create(&tid2, &attr, producer, "生产者2");
    pthread_create(&tid3, &attr, customer, "消费者1");
    pthread_create(&tid4, &attr, customer, "消费者2");
